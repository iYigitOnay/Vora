...
- **Mutfağım:** 
    - *Besin Kütüphanesi:* Kayıtlı besinler ve öğün kombinasyonları (Örn: "Standart Kahvaltım").
    - *Dijital Kiler:* Stok takibi (Pirinç, supplement vb.). Tüketim yapıldıkça stoktan otomatik düşer.
